...
_BOUND_SCHEMAS = (
    ...
    "score-director-host-request-v1.json",
    "score-director-host-submission-v1.json",
    "score-director-host-ingest-claim-v1.json",
    "score-director-host-ingest-receipt-v1.json",
